...
/** Ejemplo para entender el concepto de renderers y editors de JTable
...
public class EjemploRenderersYEditors {
	...
	public static void main(String[] args) {
		...
		// EDITORES
		// Se podría hacer con el editor por defecto...
		// tabla.setDefaultEditor( Object.class, new DefaultCellEditor( new JTextField() ) {
			// Cambiar solo lo que quiera que se haga distinto
		// });
		
		// Y también con el interfaz, programando todos los métodos:
		...
		MouseAdapter ma = new MouseAdapter() {  // MouseAdapter implementa tanto ML como MML
			...
			public void mouseDragged(MouseEvent e) {
				...
				// Hacer aquí lo que se quiera con el drag - por ejemplo que se pinte 
